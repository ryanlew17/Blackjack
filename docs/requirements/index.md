...
> 关联需求：本文件即需求索引。
> 最后更新：2026-09-22
> 来源：2026-09-22 文档架构升级新建；首批两条为 2026-09-22 重构终审遗留的 minor；REQ-003–006 来自用户确认的规则 v2 里程碑计划；2026-09-22 REQ-001、REQ-002 完成验收并归档，中间产物提炼进各需求文档
...
REQ-2026-001–006 全部完成并归档（`archive/`）。
