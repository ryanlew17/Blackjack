...
> 关联需求：本文件即需求索引。
> 最后更新：2026-09-22
> 来源：2026-09-22 文档架构升级新建；首批两条为 2026-09-22 重构终审遗留的 minor；REQ-003–006 来自用户确认的规则 v2 里程碑计划；2026-09-22 REQ-001、REQ-002 完成验收并归档，中间产物提炼进各需求文档；REQ-2026-007 用户于 v0.1.0 发布后新增；REQ-2026-008–011 由 2026-09-22 第三方 UX 审查发现、用户确认后登记；2026-09-22 REQ-2026-008 完成验收并归档
...
| [REQ-2026-009](./active/REQ-2026-009-css-patch-consolidation.md)        | styles.css 补丁值精简（零视觉变更）     | active | 用户（UX 审查） | src/presentation/styles.css                                           | docs/design/ui.md                                                                                                        | 2026-09-22 |
| [REQ-2026-010](./active/REQ-2026-010-touch-action-hints.md)             | 玩家动作提示触屏可达                    | active | 用户（UX 审查） | src/presentation/                                                     | docs/design/ui.md                                                                                                        | 2026-09-22 |
| [REQ-2026-011](./active/REQ-2026-011-interaction-semantics.md)          | 交互语义修缮（品牌区/旧档导出/焦点）    | active | 用户（UX 审查） | src/presentation/                                                     | docs/design/ui.md                                                                                                        | 2026-09-22 |

REQ-2026-001–008 全部完成并归档（[archive/](./archive/)）；REQ-2026-007 随 v0.1.2 交付，REQ-2026-008 于 bug-fix 分支交付（版本号不变）。REQ-2026-009–011 为 2026-09-22 第三方 UX 审查新增（用户确认），进行中，见 [active/](./active/)。
