...
- 规则面板、中英文结果文案、保险导入阶段及旧档版本提示同步更新。按钮通过原生 Tab/Enter/Space 操作；不新增自定义快捷键。
- 牌桌增高以容纳状态标签；移动端双列手牌与可换行操作按钮。320px 中英文已完成生产产物验收，具体引擎覆盖见 `../requirements/v2-acceptance-report.md`。
